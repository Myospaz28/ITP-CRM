...
import ClientForm from './EditCall.js';
...
const Call: React.FC = () => {
  ...
  useEffect(() => {
    async function fetchclients() {
      try {
        const response = await fetch(BASE_URL + 'api/client-list'); 
        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-left dark:bg-meta-4">
              ...
              <th className="py-4 px-4 font-medium text-black dark:text-white">Assign Date</th>
              <th className="py-4 px-4 font-medium text-black dark:text-white">Target Date</th>
              <th className="py-4 px-4 font-medium text-black dark:text-white">Call Status</th>
              <th className="py-4 px-4 font-medium text-black dark:text-white">Call Remark</th>
