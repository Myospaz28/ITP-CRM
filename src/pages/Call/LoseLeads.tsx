...
// const LoseLeads = () => {
//   const [loseLeads, setLoseLeads] = useState<any[]>([]);
//   const [searchTerm, setSearchTerm] = useState('');
//   const [currentPage, setCurrentPage] = useState(1);
...
//   // ---------------- UNIQUE FILTER OPTIONS (ES5 SAFE) ----------------
//   const telecallers = loseLeads
//     .map((l) => l.assigned_to)
//     .filter((v, i, self) => v && self.indexOf(v) === i);

//   const sourcesList = loseLeads
//     .map((l) => l.source_name)
//     .filter((v, i, self) => v && self.indexOf(v) === i);

//   const leadStages = loseLeads
//     .map((l) => l.stage_name)
//     .filter((v, i, self) => v && self.indexOf(v) === i);
...
//     const matchesStage = selectedLeadStage
...
//                 </td>
//                 <td className="p-3">{lead.source_name}</td>
//                 <td className="p-3">{lead.assigned_to}</td>
//                 <td className="p-3">{lead.stage_name}</td>
//                 <td className="p-3">{lead.lead_sub_stage_name}</td>
...
//                       setEditModalOpen(true);
//                     }}
//                     className="bg-meta-3 px-3 py-1 text-white rounded"
//                   >
//                     <FaEdit />
//                   </button>
  ...
  return (
    <div className="p-5">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-semibold">Lose Leads</h2>

        {/* RIGHT SIDE COUNT */}
        <div className="text-sm font-medium text-gray-700 bg-gray-100 px-4 py-1.5 rounded-full">
          Total: {loseLeads.length} | Showing: {filteredData.length}
        </div>
      </div>
