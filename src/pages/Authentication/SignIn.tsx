...
import Logo from '../../images/logo/matrix2.png';
...
function SignIn({ handleLogin }: { handleLogin: (auth: boolean, role: string) => void }) {
  ...
  return (
    <div>
      ...
      <div className=" rounded-sm border border-stroke flex items-center h-screen bg-white shadow-default align-content-center dark:border-strokedark dark:bg-boxdark">
         ...
         <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                ...
                <img className=" min-w-xs h-25 w-72" src={Logo} alt="Logo" />
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Sign in to start...</span>
...
//   const handleSubmit = async (event) => {
    ...
    //     handleLogin(username, password); // proceed to dashboard
    //   } else {
